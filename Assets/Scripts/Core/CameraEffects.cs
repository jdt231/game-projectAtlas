...
public class CameraEffects : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        /*
        if (!(GetComponent<CinemachineConfiner>().m_BoundingShape2D))
        {
            GameObject cameraConfiner = GameObject.FindGameObjectWithTag("CameraConfiner");
            Collider2D confinerColiider = cameraConfiner.GetComponent<PolygonCollider2D>();
            GetComponent<CinemachineConfiner>().m_BoundingShape2D = confinerColiider;
        }
        */
    }
